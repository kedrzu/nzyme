    ...
    <div class="config-view">
        ...
        <main class="table-container">
            ...
            >
                ...
                <Column field="displayName" header="Logger" style="width: 40%">
                    <template #body="{ data }">
                        <span
                            class="logger-name"
                ...
                <Column header="All" style="width: 60px" class="level-column">
                    <template #body="{ data }">
                        <Checkbox
            ...
            <div v-if="loggerRows.length === 0" class="empty-state">
