...
export function mapToMap<T, K, R>(arr: Iterable<T>, key: (item: T) => K, value: (item: T) => R): Map<K, R>;
export function mapToMap<T, K>(arr: Iterable<T>, key: (item: T) => K, value?: (item: T) => unknown) {
