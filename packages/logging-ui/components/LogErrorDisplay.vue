...
<template>
    <div class="error-display" :class="{ 'is-nested': currentDepth > 0 }">
        <div v-if="title || error.name" class="error-header">
        ...
        <div class="error-content">
            ...
            <div v-if="additionalData" class="error-data">
                <div v-for="(value, key) in additionalData" :key="key" class="error-data-item">
            ...
            <div v-if="frames.length > 0 && !isAggregateError" class="stack-trace">
                <div v-for="(frame, index) in frames" :key="index" class="stack-line">
            ...
            <!-- AggregateError's errors array -->
            <div v-if="aggregateErrors.length > 0 && currentDepth < maxDepth" class="aggregate-errors">
            ...
            <div v-if="error.cause && currentDepth < maxDepth" class="error-cause">
                <LogErrorDisplay
