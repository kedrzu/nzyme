...
- **ioc:** add constValue and defineEnvVariable helpers ([6cacecf](https://github.com/kedrzu/nzyme/commit/6cacecf))
...
- `@nzyme/eslint@0.2.0`, `@nzyme/ioc@0.2.0`
    - feat(ioc): add constValue and defineEnvVariable helpers ([@kedrzu](https://github.com/kedrzu))
